# encoding: utf-8
# module h5py.h5p
# from C:\Users\austi\Anaconda3\lib\site-packages\h5py\h5p.cp36-win_amd64.pyd
# by generator 1.145
...
DATASET_ACCESS = None # (!) real value is ''

DATASET_CREATE = None # (!) real value is ''

DATASET_XFER = None # (!) real value is ''

FILE_ACCESS = None # (!) real value is ''

FILE_CREATE = None # (!) real value is ''

GROUP_CREATE = None # (!) real value is ''

LINK_ACCESS = None # (!) real value is ''

LINK_CREATE = None # (!) real value is ''

NO_CLASS = None # (!) real value is ''

OBJECT_COPY = None # (!) real value is ''

OBJECT_CREATE = None # (!) real value is ''
