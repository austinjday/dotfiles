...
__pyx_capi__ = {
    'c_diff': None, # (!) real value is ''
    'c_merge_sorted': None, # (!) real value is ''
    'concat': None, # (!) real value is ''
    'cons': None, # (!) real value is ''
    'count': None, # (!) real value is ''
    'drop': None, # (!) real value is ''
    'first': None, # (!) real value is ''
    'frequencies': None, # (!) real value is ''
    'get': None, # (!) real value is ''
    'getter': None, # (!) real value is ''
    'groupby': None, # (!) real value is ''
    'isdistinct': None, # (!) real value is ''
    'isiterable': None, # (!) real value is ''
    'join': None, # (!) real value is ''
    'last': None, # (!) real value is ''
    'mapcat': None, # (!) real value is ''
    'nth': None, # (!) real value is ''
    'partition': None, # (!) real value is ''
    'peek': None, # (!) real value is ''
    'pluck': None, # (!) real value is ''
    'reduceby': None, # (!) real value is ''
    'rest': None, # (!) real value is ''
    'second': None, # (!) real value is ''
    'tail': None, # (!) real value is ''
    'take': None, # (!) real value is ''
    'take_nth': None, # (!) real value is ''
    'topk': None, # (!) real value is ''
    'unique': None, # (!) real value is ''
}
