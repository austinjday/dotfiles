...
# from C:\Users\austi\Anaconda3\lib\site-packages\cytoolz\dicttoolz.cp36-win_amd64.pyd
# by generator 1.145
# no doc
...
def dissoc(d, *keys): # real signature unknown; restored from __doc__
    """
    dissoc(d, *keys)
...
__pyx_capi__ = {
    'PyMapping_Next': None, # (!) real value is ''
    'assoc': None, # (!) real value is ''
    'assoc_in': None, # (!) real value is ''
    'c_dissoc': None, # (!) real value is ''
    'c_merge': None, # (!) real value is ''
    'c_merge_with': None, # (!) real value is ''
    'get_in': None, # (!) real value is ''
    'get_map_iter': None, # (!) real value is ''
    'itemfilter': None, # (!) real value is ''
    'itemmap': None, # (!) real value is ''
    'keyfilter': None, # (!) real value is ''
    'keymap': None, # (!) real value is ''
    'update_in': None, # (!) real value is ''
    'valfilter': None, # (!) real value is ''
    'valmap': None, # (!) real value is ''
}
