# encoding: utf-8
# module pandas.msgpack._unpacker
# from C:\Users\austi\Anaconda3\lib\site-packages\pandas\msgpack\_unpacker.cp36-win_amd64.pyd
# by generator 1.145
# no doc

# imports
import builtins as __builtins__ # <module 'builtins' (built-in)>
import pandas.msgpack as __pandas_msgpack
import pandas.msgpack.exceptions as __pandas_msgpack_exceptions
...
class BufferFull(__pandas_msgpack_exceptions.UnpackException):
    # no doc
...
class ExtType(__pandas_msgpack.ExtType):
...
class OutOfData(__pandas_msgpack_exceptions.UnpackException):
    # no doc
    def __init__(self, *args, **kwargs): # real signature unknown
        pass
...
class UnpackValueError(__pandas_msgpack_exceptions.UnpackException, ValueError):
    # no doc
    def __init__(self, *args, **kwargs): # real signature unknown
        pass
