...
def _get_vml_version(*args, **kwargs): # real signature unknown
...
def _set_vml_accuracy_mode(*args, **kwargs): # real signature unknown
    """ Set accuracy mode for VML functions. """
    pass

def _set_vml_num_threads(*args, **kwargs): # real signature unknown
