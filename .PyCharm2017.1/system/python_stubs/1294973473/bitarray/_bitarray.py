...
# from C:\Users\austi\Anaconda3\lib\site-packages\bitarray\_bitarray.cp36-win_amd64.pyd
# by generator 1.145
# no doc
# no imports
...
class _bitarray(object):
    ...
    def _decode(self, tree): # real signature unknown; restored from __doc__
        """
        _decode(tree) -> list
    ...
    def _encode(self, code, iterable): # real signature unknown; restored from __doc__
        """
    ...
    def _iterdecode(self, tree): # real signature unknown; restored from __doc__
        """
