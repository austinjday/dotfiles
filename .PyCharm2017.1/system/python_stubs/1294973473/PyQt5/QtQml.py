# encoding: utf-8
# module PyQt5.QtQml
# from C:\Users\austi\Anaconda3\lib\site-packages\PyQt5\QtQml.pyd
# by generator 1.145
# no doc
...
class QJSValue(): # skipped bases: <class 'sip.simplewrapper'>
    """
    ...
    """
    def call(self, args=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ call(self, args: object = QList&lt;QJSValue&gt;()) -> QJSValue """
        pass

    def callAsConstructor(self, args=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ callAsConstructor(self, args: object = QList&lt;QJSValue&gt;()) -> QJSValue """
        pass
    ...
    def callWithInstance(self, Union, QJSValue=None, QJSValue_SpecialValue=None, bool=None, p_int=None, p_float=None, p_str=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        """ callWithInstance(self, Union[QJSValue, QJSValue.SpecialValue, bool, int, float, str], args: object = QList&lt;QJSValue&gt;()) -> QJSValue """
        pass
...
class QJSValueIterator(): # skipped bases: <class 'sip.simplewrapper'>
...
class QQmlAbstractUrlInterceptor(): # skipped bases: <class 'sip.simplewrapper'>
    """
...
class QQmlEngine(QJSEngine):
    ...
    def importPlugin(self, p_str, p_str_1, p_object): # real signature unknown; restored from __doc__
...
class QQmlError(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QQmlError()
    QQmlError(QQmlError)
    """
...
class QQmlImageProviderBase(): # skipped bases: <class 'sip.wrapper'>
    # no doc
...
class QQmlIncubationController(): # skipped bases: <class 'sip.simplewrapper'>
...
class QQmlIncubator(): # skipped bases: <class 'sip.simplewrapper'>
...
class QQmlListReference(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QQmlListReference()
...
class QQmlNetworkAccessManagerFactory(): # skipped bases: <class 'sip.simplewrapper'>
    """
...
class QQmlParserStatus(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QQmlParserStatus()
...
class QQmlProperty(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QQmlProperty()
...
class QQmlPropertyValueSource(): # skipped bases: <class 'sip.simplewrapper'>
    """
...
class QQmlScriptString(): # skipped bases: <class 'sip.simplewrapper'>
    """
    QQmlScriptString()
