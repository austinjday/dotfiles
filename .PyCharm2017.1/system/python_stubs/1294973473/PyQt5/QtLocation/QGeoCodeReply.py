...
class QGeoCodeReply(__PyQt5_QtCore.QObject):
    ...
    def error(self, QGeoCodeReply_Error=None, p_str=''): # real signature unknown; restored from __doc__ with multiple overloads
        """
        error(self) -> QGeoCodeReply.Error
        error(self, QGeoCodeReply.Error, str = '') [signal]
        """
        pass
