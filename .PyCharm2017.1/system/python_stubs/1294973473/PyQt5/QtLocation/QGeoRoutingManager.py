...
# from C:\Users\austi\Anaconda3\lib\site-packages\PyQt5\QtLocation.pyd
# by generator 1.145
# no doc
...
class QGeoRoutingManager(__PyQt5_QtCore.QObject):
    ...
    def error(self, QGeoRouteReply, QGeoRouteReply_Error, p_str=''): # real signature unknown; restored from __doc__
        """ error(self, QGeoRouteReply, QGeoRouteReply.Error, str = '') [signal] """
        pass
