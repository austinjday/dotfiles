...
# from C:\Users\austi\Anaconda3\lib\site-packages\PyQt5\QtWinExtras.pyd
# by generator 1.145
# no doc
...
class QtWin(): # skipped bases: <class 'sip.simplewrapper'>
    # no doc
...
class QWinJumpList(__PyQt5_QtCore.QObject):
    ...
    def addCategory(self, *__args): # real signature unknown; restored from __doc__ with multiple overloads
        ...
        addCategory(self, str, items: object = QList&lt;QWinJumpListItem*&gt;()) -> QWinJumpListCategory
        """
        pass
...
class QWinJumpListCategory(): # skipped bases: <class 'sip.wrapper'>
...
class QWinJumpListItem(): # skipped bases: <class 'sip.wrapper'>
...
class QWinThumbnailToolBar(__PyQt5_QtCore.QObject):
    ...
    def setButtons(self, p_object): # real signature unknown; restored from __doc__
        """ setButtons(self, object) """
        pass
