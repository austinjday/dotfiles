# encoding: utf-8
# module PyQt5.QtDBus
# from C:\Users\austi\Anaconda3\lib\site-packages\PyQt5\QtDBus.pyd
# by generator 1.145
# no doc
...
class QDBus(): # skipped bases: <class 'sip.simplewrapper'>
    # no doc
...
class QDBusConnectionInterface(QDBusAbstractInterface):
    ...
    def registeredServiceNames(self): # real signature unknown; restored from __doc__
        """ registeredServiceNames(self) -> object """
        return object()
...
class QDBusPendingCallWatcher(__PyQt5_QtCore.QObject, QDBusPendingCall):
    ...
    def finished(self, QDBusPendingCallWatcher=None): # real signature unknown; restored from __doc__
        """ finished(self, QDBusPendingCallWatcher = None) [signal] """
        pass
