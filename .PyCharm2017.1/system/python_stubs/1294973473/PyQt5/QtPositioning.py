...
# from C:\Users\austi\Anaconda3\lib\site-packages\PyQt5\QtPositioning.pyd
# by generator 1.145
# no doc
...
class QGeoAddress(): # skipped bases: <class 'sip.wrapper'>
    """
    QGeoAddress()
...
class QGeoAreaMonitorInfo(): # skipped bases: <class 'sip.wrapper'>
    """
...
class QGeoShape(): # skipped bases: <class 'sip.wrapper'>
    """
    QGeoShape()
    QGeoShape(QGeoShape)
    """
...
class QGeoCoordinate(): # skipped bases: <class 'sip.wrapper'>
    """
    QGeoCoordinate()
...
class QGeoLocation(): # skipped bases: <class 'sip.wrapper'>
    """
    QGeoLocation()
...
class QGeoPositionInfo(): # skipped bases: <class 'sip.wrapper'>
    """
    QGeoPositionInfo()
...
class QGeoSatelliteInfo(): # skipped bases: <class 'sip.wrapper'>
    """
    QGeoSatelliteInfo()
...
class QGeoSatelliteInfoSource(__PyQt5_QtCore.QObject):
    ...
    def satellitesInViewUpdated(self, p_object): # real signature unknown; restored from __doc__
        """ satellitesInViewUpdated(self, object) [signal] """
        pass
