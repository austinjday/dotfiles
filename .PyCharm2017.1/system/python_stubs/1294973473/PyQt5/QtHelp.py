# encoding: utf-8
# module PyQt5.QtHelp
# from C:\Users\austi\Anaconda3\lib\site-packages\PyQt5\QtHelp.pyd
# by generator 1.145
# no doc
...
class QHelpEngineCore(__PyQt5_QtCore.QObject):
    ...
    def filterAttributeSets(self, p_str): # real signature unknown; restored from __doc__
        """ filterAttributeSets(self, str) -> object """
        return object()
    ...
    def linksForIdentifier(self, p_str): # real signature unknown; restored from __doc__
        """ linksForIdentifier(self, str) -> object """
        return object()
...
class QHelpSearchEngine(__PyQt5_QtCore.QObject):
    ...
    def search(self, Iterable, QHelpSearchQuery=None): # real signature unknown; restored from __doc__
