...
class QPainterPath(): # skipped bases: <class 'sip.simplewrapper'>
    ...
    def toFillPolygon(self, QTransform): # real signature unknown; restored from __doc__
        """ toFillPolygon(self, QTransform) -> QPolygonF """
        return QPolygonF

    def toFillPolygons(self, QTransform): # real signature unknown; restored from __doc__
    ...
    def toSubpathPolygons(self, QTransform): # real signature unknown; restored from __doc__
