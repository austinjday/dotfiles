...
class QSGNode(): # skipped bases: <class 'sip.wrapper'>
    """ QSGNode() """
    ...
    def markDirty(self, QSGNode_DirtyState): # real signature unknown; restored from __doc__
    ...
    def setFlags(self, QSGNode_Flags, enabled=True): # real signature unknown; restored from __doc__
