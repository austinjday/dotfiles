...
# from C:\Users\austi\Anaconda3\lib\site-packages\PyQt5\QtDesigner.pyd
# by generator 1.145
# no doc
...
class QDesignerFormWindowInterface(__PyQt5_QtWidgets.QWidget):
    ...
    def featureChanged(self, QDesignerFormWindowInterface_Feature): # real signature unknown; restored from __doc__
        """ featureChanged(self, QDesignerFormWindowInterface.Feature) [signal] """
        pass
    ...
    def hasFeature(self, QDesignerFormWindowInterface_Feature): # real signature unknown; restored from __doc__
        """ hasFeature(self, QDesignerFormWindowInterface.Feature) -> bool """
        return False
    ...
    def setFeatures(self, QDesignerFormWindowInterface_Feature): # real signature unknown; restored from __doc__
        """ setFeatures(self, QDesignerFormWindowInterface.Feature) """
        pass
