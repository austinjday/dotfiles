...
class QCamera(QMediaObject):
    ...
    def captureModeChanged(self, QCamera_CaptureModes): # real signature unknown; restored from __doc__
    ...
    def isCaptureModeSupported(self, QCamera_CaptureModes): # real signature unknown; restored from __doc__
    ...
    def searchAndLock(self, QCamera_LockTypes=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        searchAndLock(self)
    ...
    def setCaptureMode(self, QCamera_CaptureModes): # real signature unknown; restored from __doc__
    ...
    def unlock(self, QCamera_LockTypes=None): # real signature unknown; restored from __doc__ with multiple overloads
        """
        unlock(self)
