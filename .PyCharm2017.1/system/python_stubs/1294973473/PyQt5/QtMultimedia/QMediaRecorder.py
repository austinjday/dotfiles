...
class QMediaRecorder(__PyQt5_QtCore.QObject, QMediaBindableInterface):
    ...
    def availabilityChanged(self, QMultimedia_AvailabilityStatus): # real signature unknown; restored from __doc__
    ...
    def metaDataChanged(self, p_str, Any): # real signature unknown; restored from __doc__
