...
# from C:\Users\austi\Anaconda3\lib\site-packages\PyQt5\QtMultimedia.pyd
# by generator 1.145
# no doc
...
class QCameraImageCapture(__PyQt5_QtCore.QObject, QMediaBindableInterface):
    ...
    def captureDestinationChanged(self, QCameraImageCapture_CaptureDestinations): # real signature unknown; restored from __doc__
        """ captureDestinationChanged(self, QCameraImageCapture.CaptureDestinations) [signal] """
        pass
    ...
    def isCaptureDestinationSupported(self, QCameraImageCapture_CaptureDestinations): # real signature unknown; restored from __doc__
        """ isCaptureDestinationSupported(self, QCameraImageCapture.CaptureDestinations) -> bool """
        return False
    ...
    def setCaptureDestination(self, QCameraImageCapture_CaptureDestinations): # real signature unknown; restored from __doc__
        """ setCaptureDestination(self, QCameraImageCapture.CaptureDestinations) """
        pass
