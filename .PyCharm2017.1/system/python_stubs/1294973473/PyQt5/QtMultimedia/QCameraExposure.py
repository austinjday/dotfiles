...
class QCameraExposure(__PyQt5_QtCore.QObject):
    ...
    def isFlashModeSupported(self, QCameraExposure_FlashModes): # real signature unknown; restored from __doc__
    ...
    def setFlashMode(self, QCameraExposure_FlashModes): # real signature unknown; restored from __doc__
